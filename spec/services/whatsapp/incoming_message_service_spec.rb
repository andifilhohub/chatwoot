  ...
  describe '#perform' do
    ...
    context 'when valid contact message params' do
      it 'creates appropriate message and attachments' do
        params = { 'contacts' => [{ 'profile' => { 'name' => 'Kedar' }, 'wa_id' => '919746334593' }],
                   'messages' => [{ 'from' => '919446284490',
                                    ...
                                    'contacts' => [
                                      ...
                                      { 'name' => { 'first_name' => 'Genius Cloud', 'formatted_name' => 'Genius Cloud' },
        ...
        expect(m2.content).to eq('Genius Cloud')
        expect(m2.attachments.first.meta).to eq({ 'firstName' => 'Genius Cloud' })
      end
    end
