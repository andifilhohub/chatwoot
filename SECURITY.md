Genius Cloud is looking forward to working with security researchers worldwide to keep Genius Cloud and our users safe. If you have found an issue in our systems/applications, please reach out to us.
...
> Note: Please do not perform testing against Genius Cloud production services. Use a `self-hosted instance` to perform tests.
...
Thank you for keeping Genius Cloud and our users safe. 🙇
