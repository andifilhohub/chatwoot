...
# Description: Genius Cloud installation script
# OS: Ubuntu 18.04 LTS
# Script Version: 0.2
...
echo "Woot! Woot!! Genius Cloud server installation is complete"
echo "The server will be accessible at http://<server-ip>:3003"
